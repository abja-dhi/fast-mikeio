...
from .utils import  Point, Line, Polygon
from .plotting import MatplotlibShell


class DfsuVerticalProfileSigmaGeometry:
...
class DfsuVerticalProfileSigmaStatistics:
...
class DfsuVerticalProfileSigmaPlot:
    def __init__(self, dfsu):
        self.dfsu = dfsu
...
class DfsuVerticalProfileSigma:
    def __init__(self, filename, unit_conversion=1):
        self.filename = filename
        self.unit_conversion = unit_conversion
        self.dfsu = DfsuFile.Open(filename)
        self.geometry = DfsuVerticalProfileSigmaGeometry(self.dfsu)
        self.statistics = DfsuVerticalProfileSigmaStatistics(self)
        self.plot = DfsuVerticalProfileSigmaPlot(self)
