...
class Dfsu3DSigma:
    def __init__(self, filename, unit_conversion=1):
        ...
        self.geometry = Dfsu3DSigmaGeometry(self.dfsu)
        self.statistics = Dfsu3DSigmaStatistics(self)
        self.plot = Dfsu3DSigmaPlot(self)
